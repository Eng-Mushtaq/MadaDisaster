  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: TAppBar(
          ...
          actions: [
            TCartCounterIcon(
                onPressed: () => Get.to(const AdminChatScreen()),
          ...
          return contacts.isEmpty
              ...
              : DefaultTabController(
                  ...
                  child: NestedScrollView(
                    headerSliverBuilder: (_, innerBoxIsScrolled) {
                      return [
                        SliverAppBar(
                          ...
                          floating: true,
                          expandedHeight:
                              170, // Space between appbar and tab bar
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          icon: const Icon(Icons.add_circle,
                                              color: TColors.darkerGrey),
                                          onPressed: () => Get.to(() =>
                                              const AdminAddEmergencyContactsScreen()),
                                        ),
                                      ],
                                    ),
                                  ),
                    ...
                    body: TabBarView(
                      children: groupedContacts.values
                          .map((contacts) => TCategoryTab(contacts: contacts))
                          .toList(),
                    ),
                  ),
                );
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: IconButton(
            ...
            onPressed: () =>
                Get.to(() => const AdminAddEmergencyContactsScreen()),
          ),
        ));
  }

  Map<String, List<ContactModel>> groupContactsByCategory(
