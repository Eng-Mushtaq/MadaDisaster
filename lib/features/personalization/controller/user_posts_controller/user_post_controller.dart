...
import '../../../../data/repositories/my_all_posts/user_all_posts_repository.dart';
import '../../../disaster_main/models/disaster_model.dart';

class UserAllDisasterFetchController extends GetxController {
  static UserAllDisasterFetchController get instance => Get.find();

  final isLoading = false.obs;
  final disasterRepository = Get.put(UserAllDisasterPostRepository());
